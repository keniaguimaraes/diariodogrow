...
ActiveRecord::Schema.define(version: 20200131180121) do
  ...
  create_table "fotoperiodos", force: :cascade do |t|
    t.string   "descricao"
    t.integer  "horas"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "sementes", force: :cascade do |t|
  ...
  create_table "tipo_sementes", force: :cascade do |t|
    t.string   "descricao"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
  ...
  create_table "tipo_tecnicas", force: :cascade do |t|
    t.string   "nome"
    t.text     "descricao"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
